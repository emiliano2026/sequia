...
st.markdown(
    ...
    <div style="font-size: 17px; line-height: 1.6; color: #444; margin-bottom: 1.5rem;">
        <b>Análisis de la intensidad y duración de la sequía</b> en relación a las resoluciones de emergencia declaradas.<br>
        El valor de sequía representado corresponde al valor acumulado trimestral, sumatoria de los valores de intensidad de sequía:
