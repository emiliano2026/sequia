...
#st.caption("Análisis de la intensidad y duración de la sequía y su relación con las resoluciones de emergencia declaradas. El valor de sequía representado corresponde al valor acumulado trimestral, sumatoria de los valores de intensidad de sequía leve=1, moderada=2 y severa=3. El valor representado en el gráfico sintetiza la intensidad y duración de la sequía")
st.markdown(
    """
